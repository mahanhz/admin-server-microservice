...
nexusMetadata=`curl -s -L "http://192.168.1.31:8082/nexus/service/local/repositories/releases/content/com/amhzing/adminserver/admin-server-microservice/maven-metadata.xml"`
